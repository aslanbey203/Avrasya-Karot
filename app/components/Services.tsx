...
export default function Services() {
  return (
    <section id="hizmetler" className="bg-white py-16 text-slate-950 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="max-w-3xl">
          <span className="text-sm font-black uppercase tracking-[0.25em] text-orange-700">Hizmetlerimiz</span>
        ...
        <div className="mt-10 grid gap-5 sm:mt-14 sm:gap-6 md:grid-cols-2 xl:grid-cols-3">
          {services.map((service, index) => {
            ...
            return (
              <Link key={service.slug} href={`/hizmetler/${service.slug}`} className="group rounded-3xl border border-slate-200 bg-slate-50 p-5 transition hover:-translate-y-1 hover:border-orange-300 hover:shadow-xl sm:p-7">
                ...
                <span className="mt-7 inline-block font-bold text-orange-700">Detaylı incele</span>
              </Link>
            );
          })}
        </div>
